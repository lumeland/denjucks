...
function convertStatements(ast) {
  return depthWalk(ast, function (node) {
    ...
    walk(node, function (node) {
      if (
        node instanceof nodes.FilterAsync ||
